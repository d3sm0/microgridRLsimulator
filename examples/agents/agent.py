...
class Agent(object):
    ...
    def run(self):
        """
        Method that is launched in order to train and simulate the agents
        :return: Nothing
        """
        self.train_agent()
        self.simulate_agent()
    ...
    def train_agent(self):
        """
        Method used to train the RL agents
        :return: Nothing
        """
        pass
    ...
    def reset_agent(self):
        """
        Method used to reset the informatino of  the RL agents
        :return: Nothing
        """
        pass
    ...
    #     :param state: State of the agents as a list
